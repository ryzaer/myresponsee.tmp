jQuery(document).ready(function(t) {
    ...
    t(".aside-nav > ul > li.aside-submenu > a").attr("aria-haspopup", "true").click(function() {
        var ul = t(".aside-nav ul li.aside-submenu:hover > ul");
    ...
    t(".aside-nav > ul ul > li.aside-sub-submenu > a").attr("aria-haspopup", "true").click(function() {
        var ul = t(".aside-nav ul ul li:hover > ul");
        if (ul.hasClass("show-aside-ul")) {
            ul.removeClass("show-aside-ul").slideUp("slow");
        } else {
            ul.addClass("show-aside-ul").slideDown("slow");
    ...
    t(".nav-menu > ul li.submenu > a").attr("aria-haspopup", "true").click(function() {
        var ul = t(".nav-menu > ul li.submenu:hover > ul");
    ...
    t(".nav-menu > ul ul > li.sub-submenu > a").attr("aria-haspopup", "true").click(function() {
        var ul = t(".nav-menu ul ul li:hover > ul");
        if (ul.hasClass("show-ul")) {
            ul.removeClass("show-ul").slideUp("slow");
        } else {
            ul.addClass("show-ul").slideDown("slow");
    ...
    t(".tooltip-container").each(function() {
        t(this).hover(function() {
            var a = t(this).position(),
                e = t(this);
            a = e.offset();
            tip = t(this).find(".tooltip-content");
            tip_top = t(this).find(".tooltip-content.tooltip-top");
            tip_bottom = t(this).find(".tooltip-content.tooltip-bottom");
            var l = tip.height();
            tip.fadeIn("fast");
            tip_top.css({
                top: a.top - l,
